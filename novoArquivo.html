...
<slot></slot>
  ...
  <body show-background-image="" style="background-color: rgb(255, 255, 255);">
    <iframe id="backgroundImage" src="./Nova guia_files/custom_background_image.html"></iframe>
    <ntp-app realbox-can-show-secondary-side="" show-background-image_="" style="--ntp-logo-color: rgba(238, 238, 238, 1.00); --color-new-tab-page-attribution-foreground: rgba(248, 249, 250, 1.00); --color-new-tab-page-most-visited-foreground: rgba(248, 249, 250, 1.00);"><template shadowrootmode="open"><!----><!--_html_template_start_--><div id="content">
  <!--?lit$139132488$-->
  <!--?lit$139132488$-->
...
<!--_html_template_end_--></template> 
  ...
  <ntp-logo id="logo" doodle-boxed_="" single-colored=""><template shadowrootmode="open"><!----><!--_html_template_start_--><!--?lit$139132488$-->
  <div id="logo"></div>
...
.action-icon{--cr-icon-button-active-background-color:var(--color-new-tab-page-active-background);--cr-icon-button-fill-color:var(--color-searchbox-results-icon);--cr-icon-button-focus-outline-color:var(--color-searchbox-results-icon-focused-outline);--cr-icon-button-hover-background-color:var(--color-searchbox-results-button-hover);--cr-icon-button-icon-size:16px;--cr-icon-button-margin-end:0;--cr-icon-button-margin-start:0;--cr-icon-button-size:24px}
  ...
  <!--?lit$139132488$-->
    <cr-toast id="webstoreToast" duration="10000" hidden=""><template shadowrootmode="open"><!----><slot></slot></template>
      <div>Você pode encontrar cores mais antigas na Chrome Web Store</div>
...
<div id="hoverBackground" part="hoverBackground"></div></template>
  ...
  <!--?lit$139132488$-->
    <!--?lit$139132488$-->
      <cr-most-visited id="mostVisited" single-row="" reflow-on-overflow="" is-dark_="" visible_="" custom-links-enabled_=""><template shadowrootmode="open"><!----><!--_html_template_start_-->
<div id="container" style="--tile-background-color: rgba(222, 227, 234, 1.00); --column-count: 2; --row-count: 1;">
  <!--?lit$139132488$--><!---->
    <div class="tile" draggable="true" title="https://remotedesktop.google.com/?entry-point=pwa&amp;lfhs=2" data-index="0">
      <a draggable="false" href="https://remotedesktop.google.com/?entry-point=pwa&amp;lfhs=2" aria-label="https://remotedesktop.google.com/?entry-point=pwa&amp;lfhs=2">
      </a>
      <cr-icon-button id="actionMenuButton" class="icon-more-vert" tabindex="0" title="Mais ações para o atalho &quot;https://remotedesktop.google.com/?entry-point=pwa&amp;lfhs=2&quot;" data-index="0" role="button" aria-disabled="false"><template shadowrootmode="open"><!---->
<div id="icon">
  <div id="maskedImage"></div>
</div></template></cr-icon-button>
      <cr-icon-button id="removeButton" class="icon-clear" tabindex="0" title="Remover" hidden="" data-index="0" role="button" aria-disabled="false"><template shadowrootmode="open"><!---->
<div id="icon">
  <div id="maskedImage"></div>
</div></template></cr-icon-button>
      <div class="tile-icon">
        <img draggable="false" alt="" src="chrome://favicon2/?size=24&amp;scaleFactor=1x&amp;showFallbackMonogram=&amp;pageUrl=https%3A%2F%2Fremotedesktop.google.com%2F%3Fentry-point%3Dpwa%26lfhs%3D2">
        <div class="query-tile-icon" draggable="false" hidden=""></div>
      </div>
      <div class="tile-title title-ltr">
        <span><!--?lit$139132488$-->https://remotedesktop.google.com/?entry-point=pwa&amp;lfhs=2</span>
      </div>
    </div>
  <!---->
  <cr-button id="addShortcut" tabindex="0" noink="" aria-label="Adicionar atalho" title="Adicionar atalho" role="button" aria-disabled="false"><template shadowrootmode="open"><!---->
<div id="background"></div>
<slot id="prefixIcon" name="prefix-icon">
</slot>
<span id="content"><slot></slot></span>
...
<div id="hoverBackground" part="hoverBackground"></div></template>
    ...
    <div class="tile-title">
      <span><!--?lit$139132488$-->Adicionar atalho</span>
    </div>
  </cr-button>
...
<!-- This wrapper is necessary, such that the "pulse" animation is not
  ...
  <div id="content-wrapper" part="wrapper">
    ...
    <div slot="title"><!--?lit$139132488$--></div>
    <div slot="body" id="dialogContent">
      <cr-input id="dialogInputName" spellcheck="false" autofocus="" label="Nome"><template shadowrootmode="open"><!---->
...
<div id="error" aria-live="assertive"><!--?lit$139132488$--></div></template></cr-input>
...
<div id="error" aria-live="assertive"><!--?lit$139132488$--></div></template>
      </cr-input>
    </div>
...
<cr-toast id="dismissPromoButtonToast" duration="10000"><template shadowrootmode="open"><!----><slot></slot></template>
  ...
  <cr-button id="undoDismissPromoButton" aria-label="Pressione Ctrl+Z para desfazer" role="button" tabindex="0" aria-disabled="false"><template shadowrootmode="open"><!---->
<div id="background"></div>
<slot id="prefixIcon" name="prefix-icon">
</slot>
<span id="content"><slot></slot></span>
...
<!--_html_template_end_--></template>
    ...
    <!--?lit$139132488$-->
    <a id="backgroundImageAttribution" href="https://50reefs.org/">
      <div id="backgroundImageAttribution1Container">
        <div id="linkIcon"></div>
        <div id="backgroundImageAttribution1">
          <!--?lit$139132488$-->Recifes de coral, Grande Barreira de Coral
        </div>
      </div>
      <div id="backgroundImageAttribution2">
        <!--?lit$139132488$-->The Ocean Agency, Paisagens marítimas
      </div>
    </a>
